...
- 마일스톤: ①인게임 HUD(**완료**) ②기지 땅 + 건물(**완료**) ③월드맵 생성(**1차 완료**).
- 그 뒤로 더해진 것: 로컬 세이브, 기지↔월드 세션 유지, 건물 21종 실제 모델.
- **다음에 이어서 할 일과 아직 안 정한 것은 [`docs/handoff-billboard.md`](docs/handoff-billboard.md)에 있다** —
  건물을 사전 렌더 판넬로 바꾸는 검토, 기지 저작 툴, 건물 레벨 시스템.
